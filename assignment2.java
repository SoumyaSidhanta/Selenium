...
public class assignment2 {
    public static void main(String[] args) throws InterruptedException {
        ...
        * */
        ...
        driver.findElement(By.cssSelector("input[class*='ng-untouched']")).sendKeys("Soumya Sidhanta Mohanta");
        driver.findElement(By.cssSelector("div[class='form-group'] input[name='email']")).sendKeys("mohantasoumyasidhanta@gmail.com");
        ...
        dropdowns.selectByVisibleText("Female");
